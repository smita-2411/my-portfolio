...
$(document).ready(function() {
  ...
  //contact form
  const scriptURL = 'https://script.google.com/macros/s/AKfycbxCAHlDpc0gxvdMUwV1d3ZvQ6qTKrJQxDc0Syh1l6izw4qm6oVY2wJPPbBpSJ9M9txA/exec'; //Replace with your actual script URL which runs a script that saves the form data to a Google Sheet / sends an email notification, etc.
